...
export class OrdineService {
  public resourceUrl = this.applicationConfigService.getEndpointFor('api/ordines');
  public urlMultiplo = this.applicationConfigService.getEndpointFor('api/acquista');
  ...
  multiplo(oId: number, pId: number, disp: number, tot: number): Observable<HttpResponse<{}>> {
    return this.http.get(`${this.urlMultiplo}/${oId}/${pId}/${disp}/${tot}`, { observe: 'response' })
  }
